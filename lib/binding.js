...
const RawSocketClient = (function(Application) {
  _extends(RawSocketClient, Application);
  function RawSocketClient(args = {}) {
    Application.call(this, { ...args, type: 'raw-socket-client', fields: ['dst'] });
  }
  return RawSocketClient;
})(Application);
const RawSocketServer = (function(Application) {
  _extends(RawSocketServer, Application);
  function RawSocketServer(args = {}) {
    Application.call(this, { ...args, type: 'raw-socket-server', fields: ['dst'] });
  }
...
module.exports = { Network, Switch, Hub, Host, fromConfig, RawSocketClient, RawSocketServer, TCPClient, TCPServer, Ping, Sink, UDPClient, UDPServer };
